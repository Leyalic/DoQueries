...
amy =       "AHarcourt@sa.utah.edu;rchristensen@sa.utah.edu"
...
def do_monthlies():
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("UUFA_MR_ALT_LN_TRANSMT_HOLD_" + year):
        ...
        if query.startswith("UUFA_MR_DIR_LN_TRANSMT_HOLD_" + year):
            do_query(query, date + " CODirect Loan Transmit Hold " + year + ".xls", directory,
                     loans_a_attachment_list)
