...
a_mail =    "anne.maxwell@utah.edu"
ac_mail =   "acook@sa.utah.edu; cbergstrom@sa.utah.edu"
aca_mail =  "acook@sa.utah.edu; cbergstrom@sa.utah.edu; acapps@sa.utah.edu"
acakr_mail ="acook@sa.utah.edu; cbergstrom@sa.utah.edu; acapps@sa.utah.edu; Karen.Henriquez@utah.edu; rchristensen@sa.utah.edu"
act_mail =  "acook@sa.utah.edu; cbergstrom@sa.utah.edu;"
acvj_mail = "acook@sa.utah.edu; cbergstrom@sa.utah.edu; vchristensen@sa.utah.edu; jberry@sa.utah.edu"
ajk_mail = "acapps@sa.utah.edu;JLykins@sa.utah.edu;kburton@sa.utah.edu"
ak_mail =   "acapps@sa.utah.edu; karen.henriquez@utah.edu"
aka_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; anne.maxwell@utah.edu"
akar_mail = "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; anne.maxwell@utah.edu; rchristensen@sa.utah.edu"
akc_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu"
akk_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; JLykins@sa.utah.edu;kburton@sa.utah.edu"
akj_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; JLykins@sa.utah.edu;kburton@sa.utah.edu"
akr_mail =  "acapps@sa.utah.edu; karen.henriquez@utah.edu; rchristensen@sa.utah.edu"
akl_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; lly@sa.utah.edu"
akrc_mail = "acapps@sa.utah.edu; karen.henriquez@utah.edu; rchristensen@sa.utah.edu"
akrk_mail = "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; rchristensen@sa.utah.edu; JLykins@sa.utah.edu; kburton@sa.utah.edu"
akrv_mail = "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; rchristensen@sa.utah.edu; vchristensen@sa.utah.edu"
akv_mail =  "acapps@sa.utah.edu; Karen.Henriquez@utah.edu; vchristensen@sa.utah.edu"
alt_mail =  "JLykins@sa.utah.edu; kburton@sa.utah.edu; acapps@sa.utah.edu; jberry@sa.utah.edu;mplace@sa.utah.edu; swilgar@sa.utah.edu;vchristensen@sa.utah.edu;LGaray@sa.utah.edu"
acj_mail =  "acook@sa.utah.edu; cbergstrom@sa.utah.edu; JLeon@sa.utah.edu"
ca_mail =   "acapps@sa.utah.edu"
cak_mail =  "cbergstrom@sa.utah.edu; acapps@sa.utah.edu;Karen.Henriquez@utah.edu"
disb_mail = "Karen.Henriquez@utah.edu; steffany.forrest@income.utah.edu;cspringer@sa.utah.edu; kmccloyn@sa.utah.edu;lisa.zaelit@admin.utah.edu;vchristensen@sa.utah.edu; jberry@sa.utah.edu;cbergstrom@sa.utah.edu; acapps@sa.utah.edu;kburton@sa.utah.edu"
dl_mail =   "JLykins@sa.utah.edu; kburton@sa.utah.edu; acapps@sa.utah.edu;Karen.Henriquez@utah.edu;jberry@sa.utah.edu; mplace@sa.utah.edu;swilgar@sa.utah.edu; vchristensen@sa.utah.edu;LGaray@sa.utah.edu"
jen_mail =  "jberry@sa.utah.edu"
jkar_mail = "jcurl@sa.utah.edu; Karen.Henriquez@utah.edu; acapps@sa.utah.edu; rchristensen@sa.utah.edu"
ka_mail =   "JLykins@sa.utah.edu; kburton@sa.utah.edu; acapps@sa.utah.edu"
kaca_mail = "Karen.Henriquez@utah.edu; acook@sa.utah.edu; acapps@sa.utah.edu"
kak_mail =  "JLykins@sa.utah.edu; kburton@sa.utah.edu; acapps@sa.utah.edu; Karen.Henriquez@utah.edu"
kc_mail =   "Karen.Henriquez@utah.edu"
ckjk_mail = "cspringer@sa.utah.edu; jcurl@sa.utah.edu; Karen.Henriquez@utah.edu; kmccloyn@sa.utah.edu"
ckj_mail =  "cspringer@sa.utah.edu; kmccloyn@sa.utah.edu; jcurl@sa.utah.edu"
mat_mail =  "mplace@sa.utah.edu"
ms_mail =   "mplace@sa.utah.edu; swilgar@sa.utah.edu"
null_mail = ""
rac_mail =  "acook@sa.utah.edu; cbergstrom@sa.utah.edu; Raenetta King (rking@sa.utah.edu)n"
scott_mail = "swilgar@sa.utah.edu"
ss_mail =   "acook@sa.utah.edu; cbergstrom@sa.utah.edu; JLeon@sa.utah.edu; MSnow@sa.utah.edu; shansen@sa.utah.edu; jberry@sa.utah.edu; LGaray@sa.utah.edu; mplace@sa.utah.edu; swilgar@sa.utah.edu; vchristensen@sa.utah.edu"
ssj_mail =  "cbergstrom@sa.utah.edu; acook@sa.utah.edu; cspringer@sa.utah.edu; BBurke@sa.utah.edu; JLeon@sa.utah.edu; MSnow@sa.utah.edu; hilerie.harris@sa.utah.edu; vchristensen@sa.utah.edu; swilgar@sa.utah.edu; LGaray@sa.utah.edu; mplace@sa.utah.edu; jberry@sa.utah.edu"
sys_mail =  "jberry@sa.utah.edu; LGaray@sa.utah.edu; mplace@sa.utah.edu; swilgar@sa.utah.edu; vchristensen@sa.utah.edu"
v_mail =    "vchristensen@sa.utah.edu"
vm_mail =   "vchristensen@sa.utah.edu; mplace@sa.utah.edu"
vs_mail =   "vchristensen@sa.utah.edu; swilgar@sa.utah.edu"
...
dl_attachment_list = []
jen_attachment_list = []
jkar_attachment_list = []
ka_attachment_list = []
kaca_attachment_list = []
kak_attachment_list = []
kc_attachment_list = []
ckj_attachment_list = []
ckjk_attachment_list = []
mat_attachment_list = []
ms_attachment_list = []
...
def do_dailies():
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("FA_IL_CMT_CODE_OVR_AGR_LMT_" + year) | query.startswith("UUFA_IL_CMT_CDE_OVR_AGR_LMT_" + year):
            do_query(query, date + " Comment Code Over Aggregate 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_COMMENT_CODE_298_" + year) | query.startswith("UUFA_IL_COMMENT_CODE_298_" + year):
            do_query(query, date + " IASG - Pell Eligible 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_FDEG_FFBD_FBLK_FFBC_" + year) | query.startswith("UUFA_IL_FDEG_FFBD_FBLK_FFBC_" + year):
        ...
        if query.startswith("FA_IL_CORR_NOT_MARKED_SENT_" + year) | query.startswith("UUFA_IL_CORR_NOT_MARK_SENT_" + year):
            do_query(query, date + " Corrections not Marked to Sent 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_CORR_SENT_REJECT_CD1_" + year) | query.startswith("UUFA_IL_CORR_SENT_RJCT_CD1_" + year):
        ...
        if query.startswith("FA_IL_FOUT" + year + "_INC_" + year) | query.startswith("UUFA_IL_FOUT" + year + "_INC_" + year):
        ...
        if query.startswith("FA_IL_FPJ" + year + "_CHECKLIST_" + year) | query.startswith("UUFA_IL_FPJ" + year + "_CHECKLIST_" + year):
            do_query(query, date + " FPJ" + year + " Checklist 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_ISIR_02_IND_UP_DOWN_" + year) | query.startswith("UUFA_IL_ISIR_02_IND_UP_DWN_" + year):
            do_query(query, date + " ISIR Service IND UP Down 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_FEHU" + year + "_INITIATED") | query.startswith("UUFA_IL_FEHU" + year + "_INITIATED"):
            do_query(query, date + " Initiated FEHU" + year + " Checklist.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_IL_IRS_DRT_02_20" + year) | query.startswith("UUFA_IL_IRS_DRT_02_20" + year):
        ...
        if query.startswith("FA_IL_ISIR_GRAD_I_UG_FATERM_" + year) | query.startswith("UUFA_IL_ISIR_GRD_I_UG_FATRM_" + year):
            do_query(query, date + " ISIR Graduate Independent UG FATERM 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_ISIR_PRMARY_EFC_DIF_20" + year) | query.startswith("UUFA_IL_ISIR_PRMARY_EFC_DIF_" + year):
            do_query(query, date + " Primary EFC Difference 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_IL_ISIR_LOADED_NOT_PKG_" + year):
            do_query(query, date + " ISIR Loaded Not Packaged 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_NURSING_LOANS_TILA_20" + year) | query.startswith("UUFA_IL_NURSING_LOANS_TILA_" + year):
        ...
        if query.startswith("FA_IL_PELL_LEU_C_20" + year) | query.startswith("UUFA_IL_PELL_LEU_C_" + year):
            do_query(query, date + " Pell LEU Limit Flag C " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_PELL_LEU_E_20" + year) | query.startswith("UUFA_IL_PELL_LEU_E_" + year):
            do_query(query, date + " Pell LEU Limit Flag E " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_PELL_MAX_ELIGIBILITY_" + year) | query.startswith("UUFA_IL_PELL_MAX_ELIG_" + year):
            do_query(query, date + " Pell Max Eligibility " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_IL_SF_RFND_AWD_NO_POST_20" + year) | query.startswith("UUFA_IL_SF_RFND_AWD_NO_POST_" + year):
            do_query(query, date + " Refund Post Third Party 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_SUB_ISIR_NO_PACKAGE_" + year) | query.startswith("UUFA_IL_SUB_ISIR_NO_PACKAGE_" + year):
            do_query(query, date + " Subsequent ISIR Not Package Not Verified 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_VET_ACTIVE_DUTY_STAT_" + year) | query.startswith("UUFA_IL_VET_ACTV_DUTY_STAT_" + year):
        ...
        if query.startswith("UUFA_IL_V5_VER_AFTR_OTH_VER_" + year):
            do_query(query, date + " Selected for V5 after other Ver " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_UPDATED_ATB_20" + year) | query.startswith("UUFA_IL_UPDATED_ATB_" + year):
            do_query(query, date + " New ISIR Updated ATB " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_FATN_INITIATED_20" + year) | query.startswith("UUFA_IL_FATN_INITIATED_" + year):
        ...
        if query.startswith("FA_IL_FED_AID_OVERAWARD_" + year) | query.startswith("UUFA_IL_FED_AID_OVERAWARD_" + year):
            do_query(query, date + " Federal Aid Overaward " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_IL_FHST_I_HST_COMPLETE_" + year) | query.startswith("UUFA_IL_FHST_I_HST_COMPLETE_" + year):
    ...
    if ckj_attachment_list:
        mailer("", aid_year + " Daily Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if ajk_attachment_list:
        mailer("", aid_year + " Daily Queries", ajk_mail, "", ajk_attachment_list)
        del ajk_attachment_list[:]


def do_monday_weeklies():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_WR_AID_DISB_NO_ENRLD_ATH_") | query_name.startswith("UUFA_WR_AID_DISB_NO_ENR_ATH_"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("FA_WR_AID_DISB_NO_ENRLD_ATH_" + year) | query.startswith("UUFA_WR_AID_DISB_NO_ENR_ATH_" + year):
            do_query(query, date + " Athlete Disb Not Enrolled " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_WR_AID_DISB_NO_ENRLD_FED_" + year) | query.startswith("UUFA_WR_AID_DISB_NO_ENR_FED_" + year):
            do_query(query, date + " Federal Disb Not Enrolled " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_AID_DISB_NO_ENRLD_SCH_" + year) | query.startswith("UUFA_WR_AID_DISB_NO_ENR_SCH_" + year):
            do_query(query, date + " T 53 Sch Disb Not Enrolled " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_WR_AMERICORP_AWD_POSTING_" + year) | query.startswith("UUFA_WR_AMERICORP_AWD_POST_" + year):
            do_query(query, date + " Americorp Awards " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_WR_ATHLETE_NOT_DISB_" + year) | query.startswith("UUFA_WR_ATHLETE_NOT_DISB_" + year):
        ...
        if query.startswith("FA_WR_ATH_HRS_AFTER_CENSUS_" + year) | query.startswith("UUFA_WR_ATH_HRS_AFTR_CENSUS_" + year):
            do_query(query, date + " Ath Hours After Census " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_WR_ATH_SF_TERM_BALANCE_" + year) | query.startswith("UUFA_WR_ATH_SF_TERM_BALANCE_" + year):
            do_query(query, date + " Athlete Tuition Fee Balance " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_WR_AUDIT_CLASS_AID_DISB_" + year) | query.startswith("UUFA_WR_AUDIT_CLSS_AID_DISB_" + year):
            do_query(query, date + " Audit Class Aid Disbursed " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_WR_AWARD_UG_NOW_GRAD_ATH_" + year) | query.startswith("UUFA_WR_AWD_UG_NOW_GRAD_ATH_" + year):
            do_query(query, date + " Ath Awards past Grad Term " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_WR_AWRDED_UG_NOW_GRAD_FC_" + year) | query.startswith("UUFA_WR_AWD_UG_NOW_GRAD_FC_" + year):
            do_query(query, date + " Federal Awards past Grad Term " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_AWRDED_UG_NOW_GRAD_SV_" + year) | query.startswith("UUFA_WR_AWD_UG_NOW_GRAD_SV_" + year):
            do_query(query, date + " Scholar Awards past Grad Term " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_WR_CHECKLST_STATUS_ERROR_" + year) | query.startswith("UUFA_WR_CHKLST_STATUS_ERROR_" + year):
            do_query(query, date + " Checklist Status Error " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_DISB_ATH_FAILURE_" + year) | query.startswith("UUFA_WR_DISB_ATH_FAILURE_" + year):
            do_query(query, date + " Authorization Failure 20" + year + ".xlsx", disb_failure_directory,
                     null_attachment_list)

        if query.startswith("FA_WR_DL_DISBURSED_LTHT_" + year) | query.startswith("UUFA_WR_DL_DISBURSED_LTHT_" + year):
            do_query(query, date + " DL Disbursed LTHT " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_WR_DL_EC_SUSPENDED_" + year) | query.startswith("UUFA_WR_DL_EC_SUSPENDED_" + year):
            do_query(query, date + " DL Entrance Counseling Suspense " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_DL_ORIG_TRANS_PENDING_" + year) | query.startswith("UUFA_WR_DL_ORIG_TRNS_PEND_" + year):
            do_query(query, date + " DL Orig Trans Pending " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("UUFA_WR_EFT_CONSENT_VERIF"):
            do_query(query, date + " EFT Consent Verification 20" + year + ".xlsx", directory,
                     jkar_attachment_list)

        if query.startswith("FA_WR_FAFSA_CKLST_INCMP_" + year) | query.startswith("UUFA_WR_FAFSA_CKLST_INCMP_" + year):
        ...
        if  query.startswith("UUFA_WR_SPR_TOTAL_WDRN_DRP_" + year):
            do_query(query, date + " Spring Disb Total Withdrawn Drop " + year + ".xlsx", directory,
                     akr_attachment_list)

        if  query.startswith("UUFA_WR_SUM_TOTAL_WDRN_DRP_" + year):
            do_query(query, date + " Summer Disb Total Withdrawn Drop " + year + " .xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_FALL_TOTAL_WDRN_DRP_" + str(int(year)-1)):
            do_query(query, date + " Fall Disb Total Withdrawn Drop " + str(int(year)-1) + " .xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SPR_TOTAL_WDRN_DRP_" + str(int(year)-1)):
            do_query(query, date + " Spring Disb Total Withdrawn Drop " + str(int(year)-1) + " .xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUM_TOTAL_WDRN_DRP_" + str(int(year)-1)):
            do_query(query, date + " Summer Disb Total Withdrawn Drop " + str(int(year)-1) + " .xlsx", directory,
                     akr_attachment_list)
        ...
        if query.startswith("FA_WR_FGED_ISIR_DEGREE_" + year) | query.startswith("UUFA_WR_FGED_ISIR_DEGREE_" + year):
            do_query(query, date + " FGED ISIR Degree 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_FPEL" + year + "_INITIATED_AWARDED") | query.startswith("UUFA_WR_FPEL" + year + "_INITIATED_AWDED"):
            do_query(query, date + " FPEL" + year + " Initiated Pell.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_WR_GENDER_20" + year) | query.startswith("UUFA_WR_GENDER_" + year):
            do_query(query, date + " Gender Discrepancies 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_HEDU_PARAMEDIC_20" + year) | query.startswith("UUFA_WR_HEDU_PARAMEDIC_" + year):
        ...
        if query.startswith("FA_WR_HRS_DECREASE_ATH_" + year) | query.startswith("UUFA_WR_HRS_DECREASE_ATH_" + year):
            do_query(query, date + " Hours Decrease Athlete " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_WR_HRS_DECREASE_FC_" + year) | query.startswith("UUFA_WR_HRS_DECREASE_FC_" + year):
            do_query(query, date + " Hours Decrease FC " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_HRS_DECREASE_SV_" + year) | query.startswith("UUFA_WR_HRS_DECREASE_SV_" + year):
            do_query(query, date + " Hours Decrease SV " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_WR_FHST_I_HST_COMPLETE_" + year) | query.startswith("UUFA_WR_FHST_I_HST_COMPLETE_" + year):
            do_query(query, date + " HS Transcript 'C' FHST" + year + " 'I'.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_AS_EFC_" + year) | query.startswith("UUFA_WR_ISIR_AS_EFC_" + year):
            do_query(query, date + " ISIR Assumption EFC 20" + year + ".xlsx", directory,
                     mat_attachment_list)

        if query.startswith("FA_WR_ISIR_CORR_ASSESSMENT_" + year) | query.startswith("UUFA_WR_ISIR_COR_ASSESSMENT_" + year):
            do_query(query, date + " ISIR Correction Assessment " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_CORR_REJECT_" + year) | query.startswith("UUFA_WR_ISIR_CORR_REJECT_" + year):
            do_query(query, date + " ISIR Correction Rejected " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_DEGRE_ANSW_CHNGE_" + year) | query.startswith("UUFA_WR_ISIR_DGR_ANSW_CHNG_" + year):
            do_query(query, date + " ISIR Degree Answer Change " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_DEPNDCY_STAT_PRB_" + year) | query.startswith("UUFA_WR_ISIR_DEP_STAT_PRB_" + year):
            do_query(query, date + " ISIR Dependency 20" + year + ".xlsx", directory,
                     mat_attachment_list)

        if query.startswith("FA_WR_ISIR_REJECTED_CORR_" + year) | query.startswith("UUFA_WR_ISIR_REJECTED_CORR_" + year):
            do_query(query, date + " ISIR Rejected Corrections 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_REJECT_CODES_20" + year) | query.startswith("UUFA_WR_ISIR_REJECT_CODES_" + year) \
                | query.startswith("UUFA_WR_ISIR_REJECT_CODES_20" + year):
            do_query(query, date + " Rejected ISIR's 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_SS_MTCH_NOT_CON_" + year) | query.startswith("UUFA_WR_ISIR_SS_MCH_NOT_CON_" + year):
            do_query(query, date + " SS Match Not Confirmed 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_ISIR_SUSPENSE_20" + year) | query.startswith("UUFA_WR_ISIR_SUSPENSE_20" + year):
            do_query(query, date + " ISIR Suspense " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_LEGAL_ALIEN_WORK_" + year) | query.startswith("UUFA_WR_LEGAL_ALIEN_WORK_" + year):
            do_query(query, date + " Legal Alien Work 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_LN_ACCPT_STAFF_31_32_" + year) | query.startswith("UUFA_WR_LN_ACCPT_STAF_31_32_" + year):
            do_query(query, date + " Stafford Accept Offer " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_LOAN_CENSUS_DATE_" + year) | query.startswith("UUFA_WR_LOAN_CENSUS_DATE_" + year):
            do_query(query, date + " Loans Census Date 20" + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_LOAN_FA907_1_REVISED_" + year) | query.startswith("UUFA_WR_LN_FA907_1_REVISED_" + year):
            do_query(query, date + " Loan Disbursed Report " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_LOAN_FA907_2_REVISED_" + year) | query.startswith("UUFA_WR_LN_FA907_2_REVISED_" + year):
        ...
        if query.startswith("FA_WR_LOAN_SENT_NO_RESPONSE_" + year) | query.startswith("UUFA_WR_LN_SENT_NO_RESPONSE_" + year):
            do_query(query, date + " Loan Sent No Response " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_LOAN_TRANSMIT_HOLD_" + year) | query.startswith("UUFA_WR_LOAN_TRANSMIT_HOLD_" + year):
            do_query(query, date + " Loan Transmit Hold " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_LW_MD_DN_AWD_NOT_DISB_" + year) | query.startswith("UUFA_WR_LW_MD_DN_AW_NO_DISB_" + year):
            do_query(query, date + " LW MD DN Awards Not Disbursed " + year + ".xlsx", directory,
                     akc_attachment_list)

        if query.startswith("FA_WR_MONTGMR_AMCORP_OVERAW_" + year) | query.startswith("UUFA_WR_MNTGMR_AMCORP_OVRAW_" + year):
            do_query(query, date + " Montgomery Americorp Overaward " + year + ".xlsx", directory,
                     kaca_attachment_list)

        if query.startswith("FA_WR_MULTIPLE_EMPLIDS_" + year) | query.startswith("UUFA_WR_MULTIPLE_EMPLIDS_" + year):
            do_query(query, date + " Multiple EMPLIDS 20" + year + ".xlsx", directory,
                     mat_attachment_list)

        if query.startswith("FA_WR_NO_COMMENT_CODE_" + year) | query.startswith("UUFA_WR_NO_COMMENT_CODE_" + year):
            do_query(query, date + " Sub ISIR Checklist No ISIR Comment Code 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_NSLDS_LOAN_DATA_" + year) | query.startswith("UUFA_WR_NSLDS_LOAN_DATA_" + year):
            do_query(query, date + " NSLDS Loan Data .xlsx", directory,
                     akk_attachment_list)

        if query.startswith("FA_WR_OVRD_ACAD_LVL_" + year) | query.startswith("UUFA_WR_OVRD_ACAD_LVL_" + year):
        ...
        if query.startswith("UUFA_WR_PA_FDEG_CHECKLIST"):
            do_query(query, date + " PA Expected Grad Date Blank 20" + year + "U.xlsx", directory,
                     akc_attachment_list)

        if query.startswith("FA_WR_PELL_AWRD_LOCK_" + year) | query.startswith("UUFA_WR_PELL_AWRD_LOCK_" + year):
            do_query(query, date + " Pell Award Lock No FPEL" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_OVERPAYMENT_" + year) | query.startswith("UUFA_WR_PELL_OVERPAYMENT_" + year):
            do_query(query, date + " Pell Ovpy Check NSLDS 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_SUMMER_NO_PELL_" + year) | query.startswith("UUFA_WR_PELL_SUMMER_NO_PELL_" + year):
            do_query(query, date + " Pell Summer No Pell 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_TERM_FT_" + year) | query.startswith("UUFA_WR_PELL_TERM_FT_" + year):
            do_query(query, date + " Term Pell Awards FT 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_TERM_HT_" + year) | query.startswith("UUFA_WR_PELL_TERM_HT_" + year):
            do_query(query, date + " Term Pell Awards HT 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_TERM_LH_" + year) | query.startswith("UUFA_WR_PELL_TERM_LH_" + year):
            do_query(query, date + " Term Pell Awards LH 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_TERM_NL_" + year) | query.startswith("UUFA_WR_PELL_TERM_NL_" + year):
            do_query(query, date + " Term Pell Awards NL 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PELL_TERM_TQ_" + year) | query.startswith("UUFA_WR_PELL_TERM_TQ_" + year):
            do_query(query, date + " Term Pell Awards TQ 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_PERK_SPLIT_MISMATCH_" + year) | query.startswith("UUFA_WR_PERK_SPLIT_MISMATCH_" + year):
            do_query(query, date + " Perkins Plan Split Mismatch " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_QUALITY_ASSURANCE_" + year) | query.startswith("UUFA_WR_QUALITY_ASSURANCE_" + year):
        ...
        if query.startswith("FA_WR_SCHOLARSHIP_NOT_DISB_" + year) | query.startswith("UUFA_WR_SCH_NOT_DISB_" + year):
            do_query(query, date + " Cash Non-Cash Sch Not Disb " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_WR_SSR_MATCH_NOT_CONFRMD_" + year) | query.startswith("UUFA_WR_SSR_MATCH_NOT_CNFRM_" + year):
            do_query(query, date + " SSR Not Confirmed 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SSR_NOT_CONFRMED_VTRN_" + year) | query.startswith("UUFA_WR_SSR_NOT_CNFRMD_VTRN_" + year):
            do_query(query, date + " VA Match SSR DB Override " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SS_DB_OVERRIDE_" + year) | query.startswith("UUFA_WR_SS_DB_OVERRIDE_" + year):
            do_query(query, date + " SS DB Override " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUB_ISIR_PACKAGED_" + year) | query.startswith("UUFA_WR_SUB_ISIR_PACKAGED_" + year):
            do_query(query, date + " Subsequent ISIR Packaged 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUB_ISIR_REAWARD_AID_" + year) | query.startswith("UUFA_WR_SUB_ISIR_REAWD_AID_" + year):
            do_query(query, date + " Canceled FCOR Complete " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUB_ISIR_SYSG_20" + year) | query.startswith("UUFA_WR_SUB_ISIR_SYSG_20" + year):
            do_query(query, date + " Subsequent ISIR System Generated 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUB_ISIR_VERIFIED_" + year) | query.startswith("UUFA_WR_SUB_ISIR_VERIFIED_" + year):
            do_query(query, date + " Subsequent ISIR Verified 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUMMER_NO_DL_" + year) | query.startswith("UUFA_WR_SUMMER_NO_DL_" + year):
            do_query(query, date + " Summer Enroll No DL " + year + ".xlsx", directory,
                     akk_attachment_list)

        if query.startswith("UUFA_WR_SSP_DOB_PRB_APPLCNT_" + year):
            do_query(query, date + " Suspense Applicant DOB Problem " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_WR_SSP_NAME_PRB_APLCNT_" + year):
            do_query(query, date + " Suspense Applicant Name Problem " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_WR_SSP_SSN_PRB_APLCNT_" + year):
            do_query(query, date + " Suspense Applicant SSN Problem " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_TERM_NSLDS_LOAN_YR_" + year) | query.startswith("UUFA_WR_TERM_NSLDS_LOAN_YR_" + year):
            do_query(query, date + " NSLDS Loan Year Blank " + year + ".xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_WR_TITLE_VII_MED_LOANS_" + year) | query.startswith("UUFA_WR_TITLE_VII_MED_LOANS_" + year):
            do_query(query, date + " Title VII Medical Loans TILA 20" + year + ".xlsx", directory,
                     akc_attachment_list)

        if query.startswith("FA_WR_TRANSFER_ENT_CNS_" + year) | query.startswith("UUFA_WR_TRANSFER_ENT_CNS_" + year):
            do_query(query, date + " Transfer Students Entrance Counseling 20" + year + ".xlsx", directory,
                     kak_attachment_list)

        if query.startswith("FA_WR_TRANSFER_STDNTS_FA_SP_" + year) | query.startswith("UUFA_WR_TRANSFER_STU_FA_SP_" + year):
        ...
        if query.startswith("UUFA_WR_UAC_SNGDO_20" + year):
            do_query(query, date + " UAC SNGDO Campus 20" + year + ".xlsx", directory,
                     ak_attachment_list)
        ...
        if query.startswith("FA_WR_VERI_CHKLST_MISSING_" + year) | query.startswith("UUFA_WR_VERI_CHKLST_MISSING_" + year):
            do_query(query, date + " Verification Checklist Missing 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_VERI_INCOME_ADJ_20" + year) | query.startswith("UUFA_WR_VERI_INCOME_ADJ_20" + year):
            do_query(query, date + " Income Adjustments 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_VER_NOT_CONSL_20" + year) | query.startswith("UUFA_WR_VER_NOT_CONSL_20" + year):
            do_query(query, date + " Verification Not Consolidated 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_VETERAN_ACTIVE_DUTY_" + year) | query.startswith("UUFA_WR_VETERAN_ACTIVE_DUTY_" + year):
            do_query(query, date + " Veteran Active Duty 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_VETERAN_NO_QUALIFY_" + year) | query.startswith("UUFA_WR_VETERAN_NO_QUALIFY_" + year):
            do_query(query, date + " Veteran No Qualify 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_WEEKS_OF_INSTR_FIX_" + year) | query.startswith("UUFA_WR_WEEKS_OF_INSTR_FIX_" + year):
            do_query(query, date + " Weeks of Instruction 20" + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_DL_AY_SP_CANCELLED_" + year) | query.startswith("UUFA_WR_DL_AY_SP_CANCELED_" + year):
        ...
        if query.startswith("FA_WR_RT4_FALL_DROP_CLASSES_" + year) | query.startswith("UUFA_WR_RT4_FA_DROP_CLASSES_" + year):
            do_query(query, date + " RT4 Fall Drop Classes 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_WR_RT4_SPR_DROP_CLASSES_" + year) | query.startswith("UUFA_WR_RT4_SP_DROP_CLASSES_" + year):
            do_query(query, date + " RT4 Spring Drop Classes 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_WR_RT4_SUM_DROP_CLASSES_" + year) | query.startswith("UUFA_WR_RT4_SU_DROP_CLASSES_" + year):
            do_query(query, date + " RT4 Summer Drop Classes 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        # Manually run Queries
        if query.startswith("FA_WR_LOAN_EFT_DETAIL_ERROR") | query.startswith("UUFA_WR_LOAN_EFT_DETAIL_ERROR"):
        ...
        if query.startswith("FA_WR_SNGDO_CAMPUS_20" + year) | query.startswith("UUFA_WR_SNGDO_CAMPUS_20" + year):
    ...
    if acj_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", acj_mail, "", acj_attachment_list)
        del acj_attachment_list[:]
    if ckj_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if akr_attachment_list:
    ...
    if jkar_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", jkar_mail, "", jkar_attachment_list)
        del jkar_attachment_list[:]


def do_budget_queries():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_BR_ACAD_LVLS_OUT_OF_SYNC") | query_name.startswith("UUFA_BR_ACAD_LVLS_OUT_SYNC"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    # Create FOLDER variables to be used in Move() operation and establishes the directory to save the files
    ...
    # will be added.
    for query in os.listdir("."):
        if query.startswith("FA_BR_ACAD_LVLS_OUT_OF_SYNC_" + year) | query.startswith("UUFA_BR_ACAD_LVLS_OUT_SYNC_" + year):
            do_query(query, date + " GR Academic Levels Out of Sync " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_BR_ATH_TUITION_INCREASE_" + year) | query.startswith("UUFA_BR_ATH_TUIT_INCR_NR_" + year):
            do_query(query, date + " Athlete Tuition Increase " + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_BR_ATHLETE_TUIT_INCR_NR_" + year) | query.startswith("UUFA_BR_ATH_TUITION_INCRS_" + year):
            do_query(query, date + " Athlete Tuition Increase Non Resident 20" + year + ".xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_BR_BUDGET_DOUBLE_BUDGETS_" + year) | query.startswith("UUFA_BR_BDGT_DOUBLE_BUDGETS_" + year):
        ...
        if query.startswith("FA_BR_COA_TUIT_ZERO_" + year) | query.startswith("UUFA_BR_COA_TUIT_ZERO_" + year):
            do_query(query, date + " COA Tuition Amount Zero " + year + ".xlsx", directory,
                     akv_attachment_list)

        if query.startswith("FA_BR_DN_LW_MD_STU_AID_ATRB_" + year) | query.startswith("UUFA_BR_DN_LW_MD_AID_ATRB_" + year):
            do_query(query, date + " DN-LW-MD Student Aid Career " + year + ".xlsx", directory,
                     akc_attachment_list)

        if query.startswith("FA_BR_FT_CLASS_OVERRIDES_" + year) | query.startswith("UUFA_BR_FT_CLASS_OVERRIDES_" + year):
        ...
        if query.startswith("FA_BR_NO_BUDGET_ATTEND_20" + year) | query.startswith("UUFA_BR_NO_BUDGET_ATTEND_" + year):
            do_query(query, date + " NO Budget Attend 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_BR_NSLDS_NO_MATCH_DB_FLG_" + year) | query.startswith("UUFA_BR_NSLDS_NO_MCH_DB_FLG_" + year):
            do_query(query, date + " NSLDS No Match DB Flag " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_BR_OMBAMBA_" + year) | query.startswith("UUFA_BR_OMBAMBA_" + year):
            do_query(query, date + " Academic Plan OMBAMBA " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_BR_PELL_COA_BLANK_" + year) | query.startswith("UUFA_BR_PELL_COA_BLANK_" + year):
            do_query(query, date + " PELL COA Blank " + year + ".xlsx", directory,
                     aka_attachment_list)

        if query.startswith("UUFA_BR_PELL_COA_DBLD_WRNG_" + year) | query.startswith("UUFA_BR_PELL_COA_DOUBLE_" + year):
        ...
        if query.startswith("FA_BR_PROC_STAT_REVIEW_STAT_" + year) | query.startswith("UUFA_BR_PROC_STAT_RVW_STAT_" + year):
            do_query(query, date + " Reset Processing Status to 1 " + year + ".xlsx", directory,
                     ms_attachment_list)

        if query.startswith("FA_BR_RES_NON_RES_BUDGET_" + year) | query.startswith("UUFA_BR_RES_NON_RES_BDGT_" + year):
            do_query(query, date + " Resident - Non-Resident Budget " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_BR_SCH_TUITION_FEES_NR_" + year) | query.startswith("UUFA_BR_SCH_TUITION_FEES_NR_" + year):
            do_query(query, date + " Waiver-Scholar Tuition Fees NR " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_BR_SCH_TUITION_ONLY_NR_" + year) | query.startswith("UUFA_BR_SCH_TUITION_ONLY_NR_" + year):
            do_query(query, date + " Waiver-Scholar Tuition Only NR " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_BR_SCHOLAR_TUITION_FEES_" + year) | query.startswith("UUFA_BR_SCHOLAR_TUIT_FEES_" + year):
            do_query(query, date + " Waiver-Scholar Tuition Fees Res " + year + ".xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_BR_SCHOLAR_TUITION_ONLY_" + year) | query.startswith("UUFA_BR_SCHOLAR_TUIT_ONLY_" + year):
            do_query(query, date + " Waiver-Scholar Tuition Only Res " + year + ".xlsx", directory,
                     act_attachment_list)
    ...
    if ak_attachment_list:
        ...
        del ak_attachment_list[:]
    if ckj_attachment_list:
        mailer("", aid_year + " Budget Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if ckj_attachment_list:
        mailer("", aid_year + " Budget Queries", ckjk_mail, "", ckjk_attachment_list)
        del ckjk_attachment_list[:]
    if akc_attachment_list:
...
def do_budget_test_queries():
    ...
    for query in os.listdir("."):
        if query.startswith("UUFA_BUDGET_20" + year + "_DN1"):
            do_query(query, date + " Wrong Budget - Dental 1.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_DN2"):
            do_query(query, date + " Wrong Budget - Dental 2.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_DN3"):
            do_query(query, date + " Wrong Budget - Dental 3.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_DN4"):
            do_query(query, date + " Wrong Budget - Dental 4.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_ACCTMAC"):
            do_query(query, date + " Wrong Budget - Accounting Masters.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_ARCHMAR"):
            do_query(query, date + " Wrong Budget - Architect Masters.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_BUSINESS"):
            do_query(query, date + " Wrong Budget - Grad Business.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_COMDIS"):
            do_query(query, date + " Wrong Budget - COMDIS.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_EAEMS"):
            do_query(query, date + " Wrong Budget - EAE.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_EDUCATION"):
            do_query(query, date + " Wrong Budget - Education.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_ED_PSYCH"):
            do_query(query, date + " Wrong Budget - ED Psychology.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_ENGINERING"):
            do_query(query, date + " Wrong Budget - Grad Engineering.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_FINE_ARTS"):
            do_query(query, date + " Wrong Budget - Fine Arts .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_GENERAL_GR"):
            do_query(query, date + " Wrong Budget - General Grad .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_GENETICS"):
            do_query(query, date + " Wrong Budget - Genetics.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_HEALTH"):
            do_query(query, date + " Wrong Budget - Health.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PRO_HEALTH"):
            do_query(query, date + " Wrong Budget - Health Promotion .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_HUMANITIES"):
            do_query(query, date + " Wrong Budget - Humanities.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_MBA_BUADMB"):
            do_query(query, date + " Wrong Budget - MBA - BUADMBA .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_MD_SCIENCE"):
            do_query(query, date + " Wrong Budget - Medical Science .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_MEDICAL"):
            do_query(query, date + " Wrong Budget - MD Graduate .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_NURSING"):
            do_query(query, date + " Wrong Budget - Graduate Nursing .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PA"):
            do_query(query, date + " Wrong Budget - Physician Assistant .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PHARMACY"):
            do_query(query, date + " Wrong Budget - Pharmacy .xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PLANNING"):
            do_query(query, date + " Wrong Budget - Planning.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PMBAMBA"):
            do_query(query, date + " Wrong Budget - PMBAMBA.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PUBLICPOLI"):
            do_query(query, date + " Wrong Budget - Public Policy.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_PUBLIC_ADM"):
            do_query(query, date + " Wrong Budget - Public Administration.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_SCIENCE"):
            do_query(query, date + " Wrong Budget - Science.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_SOC_BEHAV"):
            do_query(query, date + " Wrong Budget - Social and Behavioral.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_SW"):
            do_query(query, date + " Wrong Budget - Social Work.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_GR_XMBAMBA"):
            do_query(query, date + " Wrong Budget - XMBAMBA.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_LW1"):
            do_query(query, date + " Wrong Budget - Law 1.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_LW2"):
            do_query(query, date + " Wrong Budget - Law 2.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_LW3"):
            do_query(query, date + " Wrong Budget - Law 3.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_MD1"):
            do_query(query, date + " Wrong Budget - Med 1.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_MD2"):
            do_query(query, date + " Wrong Budget - Med 2.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_MD3"):
            do_query(query, date + " Wrong Budget - Med 3.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_MD4"):
            do_query(query, date + " Wrong Budget - Med 4.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UNDERGRAD"):
            do_query(query, date + " Wrong Budget - Undergraduate.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_BUSINESS"):
            do_query(query, date + " Wrong Budget - Undergraduate Business.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_BUS_LTHT"):
            do_query(query, date + " Wrong Budget - Undergraduate Business LTHT.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_ENGINERING"):
            do_query(query, date + " Wrong Budget - Undergraduate Engineering.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_ENG_LTHT"):
            do_query(query, date + " Wrong Budget - Undergraduate Engineering LTHT.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_LTHT"):
            do_query(query, date + " Wrong Budget - Undergraduate LTHT.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_NURSE_LTHT"):
            do_query(query, date + " Wrong Budget - Undergraduate Nursing LTHT.xlsx", directory,
                     null_attachment_list)

        if query.startswith("UUFA_BUDGET_20" + year + "_UG_NURSING"):
            do_query(query, date + " Wrong Budget - Undergraduate Nursing.xlsx", directory,
                     null_attachment_list)
...
def do_packaging_queries():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_PRT_ACAD_PROG_REVIEW") | query_name.startswith("UUFA_PRT_ACAD_PROG_REVIEW"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    # Create FOLDER variables to be used in Move() operation and establishes the directory to save the files
    ...
    # will be added.
    for query in os.listdir("."):
        if query.startswith("UUFA_PRT_ACAD_LVLS_OUT_SYNC_" + year) | query.startswith("UUFA_PRT_ACAD_LVLS_OUT_OF_SYNC"):
            do_query(query, date + " UG Acad Levels Out of Sync.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_ACAD_PROG_REVIEW_" + year) | query.startswith("UUFA_PRT_ACAD_PROG_REVIEW_" + year):
            do_query(query, date + " Academic Progress Review.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_ATHLETE_ACCEPT_FED_AID" + year) | query.startswith("UUFA_PRT_ATH_ACCEPT_FED_AID"):
            do_query(query, date + " Athlete Accepted Federal Aid.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("UUFA_PRT_ATH_AWD_CBA_GRANT_" + year) | query.startswith("UUFA_PRT_ATH_AWD_CBA_GRANT"):
            do_query(query, date + " Athlete Awarded CBA Grant.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("UUFA_PRT_ATH_GRAD_DATE_" + year) | query.startswith("UUFA_PRT_ATH_GRAD_DATE"):
            do_query(query, date + " Athlete Expected Grad Date.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_PRT_ATHLETE_OFFERED_FED_AID" + year) | query.startswith("UUFA_PRT_ATH_OFFRD_FED_AID_"):
        ...
        if query.startswith("UUFA_PRT_AWARD_DATE_HAD_SAT_" + year) | query.startswith("UUFA_PRT_AWARD_DATE_HAD_SAT"):
            do_query(query, date + " SAT Hold Date Award Review.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_AWARD_TERM_HAD_SAT_" + year) | query.startswith("UUFA_PRT_AWARD_TERM_HAD_SAT"):
            do_query(query, date + " SAT Hold Term Award Review.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_AWARDS_OTHER_INST_" + year) | query.startswith("UUFA_PRT_AWARDS_OTHER_INST"):
            do_query(query, date + " Checklist FAOI" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_AWD_CMB_OVR_AG_RVW_" + year) | query.startswith("UUFA_PRT_AWD_COMB_OVER_AGG_RVW"):
        ...
        if query.startswith("UUFA_PRT_PELL_ELG_NO_PELL_" + year) | query.startswith("UUFA_PRT_AWD_PLL_ELG_NO_PLL_" + year):
            do_query(query, date + " PELL ELIGIBLE NO PELL 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_AWD_SUB_OVR_AG_RVW_" + year) | query.startswith("UUFA_PRT_AWD_SUB_OVER_AGG_RVW"):
            do_query(query, date + " SUB Over Aggregate.xlsx", directory,
                     akj_attachment_list)

        if query.startswith("UUFA_PRT_CTZN_IND_AWD_NO_LN_" + year) | query.startswith("UUFA_PRT_CTZN_IND_AWD_NO_LOANS"):
            do_query(query, date + " LA-wk eligible - Award No Loans.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_PRT_DEFR_ENROLLMENT_" + year) | query.startswith("UUFA_PRT_DEFR_ENROLLMENT_" + year):
            do_query(query, date + " DEFER Enrollment " + year + ".xlsx", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_PRT_DEP_PRNT_SSN_RVW_" + year) | query.startswith("UUFA_PRT_DEPEND_PRNT_SSN_RVW"):
            do_query(query, date + " Parent SSN Review.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PRT_DIAG_AWARD_PELL_TERM_" + year) | query.startswith("UUFA_PRT_DIAG_AWD_PELL_TERM_" + year):
        ...
        if query.startswith("FA_PRT_DL_DPAY_SCSP_20" + year) | query.startswith("UUFA_PRT_DL_DPAY_SCSP_" + year):
        ...
        if query.startswith("FA_PRT_DL_GRAD_TERM_FALL_" + year) | query.startswith("UUFA_PRT_DL_GRAD_TERM_FALL_" + year):
            do_query(query, date + " DL Expected Grad Term Fall " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_GRAD_TERM_FALL_" + year) | query.startswith("UUFA_PRT_GRAD_TRM_FALL_" + year):
            do_query(query, date + " Loan Proration Grad Term Fall " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_GRAD_TERM_SPRING_" + year) | query.startswith("UUFA_PRT_GRAD_TRM_SPRING_" + year):
            do_query(query, date + " Loan Proration Grad Term Spring " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_GRNT_UG_5_YR_2BCH_" + year) | query.startswith("UUFA_PRT_GRANT_UG_5TH_YR_2BACH"):
        ...
        if query.startswith("FA_PRT_LEU_C_FSEOG_20" + year) | query.startswith("UUFA_PRT_LEU_C_FSEOG_" + year):
            do_query(query, date + " LEU C Flag Awarded FSEOG " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_LEU_C_PELL_AWARD_" + year) | query.startswith("UUFA_PRT_LEU_C_PELL_AWARD_" + year):
            do_query(query, date + " LEU C Flag Awarded Pell " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_LEU_E_FSEOG_20" + year) | query.startswith("UUFA_PRT_LEU_E_FSEOG_" + year):
            do_query(query, date + " LEU E Flag Awarded FSEOG " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_LN_CBA_AWD_NO_ELIG_" + year) | query.startswith("UUFA_PRT_LOAN_CBA_AWD_NOT_ELIG"):
            do_query(query, date + " Loan CBA Review Eligible.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PRT_NO_FALL_1" + str(int(year) - 1) + "8") | query.startswith("UUFA_PRT_NO_FALL_11" + str(int(year) - 1) + "8"):
            do_query(query, date + " Packaging No Fall 1" + str(int(year) - 1) + "8 (2).xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PRT_NSL_LOAN_RPT_VERI_20" + year) | query.startswith("UUFA_PRT_NSL_LOAN_RPT_VERI_" + year):
            do_query(query, date + " NSL Loan Need Verification.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_NURSING_LOAN_RPT_20" + year) | query.startswith("UUFA_PRT_NURSING_LOAN_RPT_" + year):
            do_query(query, date + " NSL Needs NSL P-N Checklist " + year + ".xlsx", directory,
                     kc_attachment_list)

        if query.startswith("UUFA_PRT_ON_LINE_PACKAGING_" + year) | query.startswith("UUFA_PRT_ON_LINE_PACKAGING"):
            do_query(query, date + " Manual Packaging Counselors.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_PELL_COMMENT_037_" + year) | query.startswith("UUFA_PRT_PELL_COMMENT_037_" + year):
            do_query(query, date + " Pell Comment Code 037 20" + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_PLL_CTZN_NO_INDCT_" + year) | query.startswith("UUFA_PRT_PLL_EL_CTZN_NOT_INDCT"):
            do_query(query, date + " Pell Eligible Citizenship Not Indicated.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PRT_PELL_FPEL" + year + "_INITIATED") | query.startswith("UUFA_PRT_PELL_FPEL" + year + "_INITIATED"):
            do_query(query, date + " Pell FPEL" + year + " Initiated.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_PELL_UG_5_YR_2_BCH_" + year) | query.startswith("UUFA_PRT_PELL_UG_5TH_YR_2ND_BA"):
            do_query(query, date + " Pell UG 5th YR.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_PHARM_NO_HEAL_" + year) | query.startswith("UUFA_PRT_PHARM_NO_HEAL"):
            do_query(query, date + " Pharmacy students with NO HEAL.xlsx", directory,
                     akj_attachment_list)

        if query.startswith("UUFA_PRT_PKG_AWD_NO_BDGT_" + year)| query.startswith("UUFA_PRT_PKG_AWARD_NO_BDGT"):
            do_query(query, date + " Award NO Budget for Term.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("UUFA_PRT_PKG_SCH_AWD_NO_BGT_" + year):
            do_query(query, date + " Scholarship Award NO Budget for Term.xlsx", directory,
                     ac_attachment_list)

        if query.startswith("UUFA_PRT_PRIOR_TRM_STFD_OFR_" + year) | query.startswith("UUFA_PRT_PRIOR_TERM_STFFRD_OFR"):
        ...
        if query.startswith("UUFA_PRT_SCHOL_GRAD_DATE_" + year) | query.startswith("UUFA_PRT_SCHOL_GRAD_DATE"):
            do_query(query, date + " Scholarship-Expected Grad Date.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_PRT_SET_HEAL_FLAG_" + year) | query.startswith("UUFA_PRT_SET_HEAL_FLAG_" + year):
            do_query(query, date + " MD - Pharmacy Heal Eligible Flag.xlsx", directory,
                     akrk_attachment_list)

        if query.startswith("UUFA_PRT_ST_OF_RES_FM_MH_PW_" + year) | query.startswith("UUFA_PRT_STATE_OF_RES_FM_MH_PW"):
        ...
        if query.startswith("FA_PRT_STUDENT_NOT_PACKAGED_" + year) | query.startswith("UUFA_PRT_STDNT_NOT_PACKAGED_" + year):
            do_query(query, date + " Students Not Packaged " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PRT_TEACH_CREDENTIAL_" + year) | query.startswith("UUFA_PRT_TEACH_CREDENTIAL_" + year):
    ...
    if ak_attachment_list:
        ...
        del ak_attachment_list[:]
    if ckj_attachment_list:
        mailer("", aid_year + " Batch Packaging Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if akr_attachment_list:
    ...
    if kak_attachment_list:
        ...
        del kak_attachment_list[:]
    if akj_attachment_list:
        mailer("", aid_year + " Batch Packaging Queries", akj_mail, "", akj_attachment_list)
        del akj_attachment_list[:]


def do_monthlies():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_MR_ATHLETE_RESIDENCY_") | query_name.startswith("UUFA_MR_ATHLETE_RESIDENCY_"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    # Create FOLDER variables to be used in Move() operation and establishes the directory to save the files
    ...
    if akr_attachment_list:
        ...
        del akr_attachment_list[:]
    if ckj_attachment_list:
        mailer("", aid_year + " Monthly Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if act_attachment_list:
...
def do_end_of_term_queries():
    ...
    input = "Error"
    for query_name in os.listdir("."):
        if query_name.startswith("FA_ACADEMIC_PLAN_RVW_FRAP") | query_name.startswith("UUFA_ACADEMIC_PLAN_RVW_FRAP"):
    ...
    for query in os.listdir("."):
        if query.startswith("FA_ACADEMIC_PLAN_RVW_FRAP") | query.startswith("UUFA_ACADEMIC_PLAN_RVW_FRAP"):
            do_query(query, date + " Academic plan RVW FRAP " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_ATHLETE_ACAD_PROG_REVIEW") | query.startswith("UUFA_ATHLETE_ACAD_PROG_REVIEW"):
            do_query(query, date + " Athlete Academic Progress Review.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_ATHLETE_CUR_PART_ALL_AWARDS") | query.startswith("UUFA_ATHLETE_CUR_PART_ALL_AWRD"):
            do_query(query, date + " Athlete Participation Report.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_CBA_ACAD_PROG_BELOW_FT") | query.startswith("UUFA_CBA_ACAD_PROG_BELOW_FT"):
            do_query(query, date + " CBA Acad Prog below FT.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_CBA_UNDISBURSED") | query.startswith("UUFA_CBA_UNDISBURSED"):
            do_query(query, date + " CBA UNDISBURSED .xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_EOT_ALT_LOAN_SAT") | query.startswith("UUFA_EOT_ALT_LOAN_SAT"):
            do_query(query, date + " Alt Loans Awards with SAT Holds.xlsx", directory,
                     kak_attachment_list)

        if query.startswith("FA_LOANS_ORIG_FAILED_PENDING") | query.startswith("UUFA_LOANS_ORIG_FAILED_PENDING"):
            do_query(query, date + " Loans Originated Failed Pending.xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_LOAN_ACAD_PROG_BELOW_HT_UND") | query.startswith("UUFA_LOAN_ACAD_PROG_BLW_HT_UND"):
            do_query(query, date + " Loan Acad Prog below HT Undisbursed.xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_LOAN_ACAD_PROG_BELOW_HT_SUB") | query.startswith("UUFA_LOAN_ACAD_PROG_BLW_HT_SUB"):
        ...
        if query.startswith("FA_LW1_LW2_LW3_SAT_WARNING") | query.startswith("UUFA_LW1_LW2_LW3_SAT_WARNING"):
            do_query(query, date + " SAT Warning LW1 LW2 LW3.xlsx", directory,
                     ka_attachment_list)

        if query.startswith("FA_MED_SAT") | query.startswith("UUFA_MED_SAT"):
            do_query(query, date + " Medical SAT Review.xlsx", directory,
                     kc_attachment_list)

        if query.startswith("FA_MR_FWS_WITH_NSI_HOLD") | query.startswith("UUFA_MR_FWS_WITH_NSI_HOLD_" + year):
            do_query(query, date + " FWS with NSI Holds.xlsx", directory,
                     a_attachment_list)

        if query.startswith("FA_PELL_ACAD_PROG_LESS_THAN") | query.startswith("UUFA_PELL_ACAD_PROG_LES_THN_" + year):
            do_query(query, date + " Pell Less Than " + year + ".xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_PELL_OFFERED_NOT_DIS") | query.startswith("UUFA_PELL_OFFERED_NOT_DIS"):
            do_query(query, date + " Pell Offered Not Disbursed.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_THESIS_STUDENTS_NONRES") | query.startswith("UUFA_THESIS_STUDENTS_NONRES"):
            do_query(query, date + " Thesis Students Non-Resident .xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_SCH_PROBATION_ACAD_PROG_RVW") | query.startswith("UUFA_SCH_PROB_ACAD_PROG_RVW"):
            do_query(query, date + " U Tradition Review.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCH_U_TRAD_ACAD_PROG_REN") | query.startswith("UUFA_SCH_U_TRAD_ACAD_PROG_REN"):
            do_query(query, date + " U Tradition Renewal.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCH_U_TRAD_ACAD_PROG_RVW") | query.startswith("UUFA_SCH_U_TRAD_ACAD_PROG_RVW"):
            do_query(query, date + " Scholarship Probation Review.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCHOLAR_ACAD_PROG_REVIEW") | query.startswith("UUFA_SCHOLAR_ACAD_PROG_REVIEW"):
            do_query(query, date + " Scholarship Academic Progress Review Basic.xlsx", directory,
                     act_attachment_list)

        if query.startswith("UUFA_SAT_AGGCP_LAW") | query.startswith("UUFA_SAT_AGGCP_LAW"):
            do_query(query, date + " SAT Aggregate Law Career.xlsx", directory,
                     akc_attachment_list)

        if query.startswith("UUFA_SAT_AGGCP_MED") | query.startswith("UUFA_SAT_AGGCP_MED"):
        ...
        if query.startswith("FA_EU_FALL_GRADE") | query.startswith("UUFA_EU_FALL_GRADE"):
            do_query(query, date + " EU Grade Fall " + str(int(year) - 1) + ".xlsx", directory,
                     akl_attachment_list)

        if query.startswith("FA_EU_SPRING_GRADE") | query.startswith("UUFA_EU_SPRING_GRADE"):
            do_query(query, date + " EU Grade Spring " + year + ".xlsx", directory,
                     akl_attachment_list)

        if query.startswith("FA_EU_SUMMER_GRADE") | query.startswith("UUFA_EU_SUMMER_GRADE"):
            do_query(query, date + " EU Grade Summer " + year + ".xlsx", directory,
                     akl_attachment_list)

        if query.startswith("FA_PELL_ELIG_ENROLL_NO_AWARD") | query.startswith("UUFA_PELL_ELIG_ENROLL_NO_AWARD"):
            do_query(query, date + " Pell Eligible Enrolled NO Award.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_SAT_FSAP") | query.startswith("UUFA_SAT_FSAP"):
            do_query(query, date + " FSAP Students.xlsx", directory,
                     ak_attachment_list)

        if query.startswith("FA_SCHOLAR_ACAD_PROG_RVW_TT") | query.startswith("UUFA_SCHOLAR_ACAD_PROG_RVW_TT"):
        ...
        if query.startswith("UUFA_SCHOLAR_ACAD_PROG_REVIEW"):
            do_query(query, date + " Scholarship Academic Progress Review.xlsx", directory,
                     act_attachment_list)

        if query.startswith("UUFA_SCH_ACAD_PROG_REVIEW_79"):
            do_query(query, date + " All 70000792 Item types Academic Progress Review.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCHOLAR_ALUMNI_CGPA") | query.startswith("UUFA_SCHOLAR_ALUMNI_CGPA"):
            do_query(query, date + " Scholarship Alumni CGPA.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCHOLAR_CASH_NO_AWARD") | query.startswith("UUFA_SCHOLAR_CASH_NO_AWARD"):
            do_query(query, date + " Scholarship Cash NO Award.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SCHOLAR_LEADER_CGPA") | query.startswith("UUFA_SCHOLAR_LEADER_CGPA"):
        ...
        if query.startswith("FA_SU_SCHOLAR_ACAD_PROG_RVW_TT") | query.startswith("UUFA_SU_SCHLR_ACAD_PROG_RVW_TT"):
            do_query(query, date + " Scholarship Academic Progress Review Top 10 Summer.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SU_SCHOLAR_ALUMNI_CGPA") | query.startswith("UUFA_SU_SCHOLAR_ALUMNI_CGPA"):
            do_query(query, date + " Scholarship CGPA Alumni - Summer.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_SU_SCHOLAR_LEADER_CGPA") | query.startswith("UUFA_SU_SCHOLAR_LEADER_CGPA"):
    ...
    if kc_attachment_list:
        ...
        del kc_attachment_list[:]
    if ckj_attachment_list:
        mailer("", "End of Term Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
...
def do_disb_queries():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_DQ_AUTHORIZED_NOT_DISB") | query_name.startswith("UUFA_DQ_AUTHORIZED_NOT_DISB"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    ...
    for query in os.listdir("."):
        if query.startswith("FA_DQ_AUTHORIZED_NOT_DISB_" + year) | query.startswith("UUFA_DQ_AUTHORIZED_NOT_DISB_" + year):
        ...
        if query.startswith("FA_CASH_DISB_TOTALS_20" + year) | query.startswith("UUFA_CASH_DISB_TOTALS_20" + year):
            do_query(query, disb_date + " Cash Disbursement Totals " + year + ".xlsx", directory,
                     sys_attachment_list)

        if query.startswith("FA_DL_FALL_20" + year) | query.startswith("UUFA_DQ_FALL_" + year):
            do_query(query, disb_date + " DL Fall Awards 20" + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_DL_FALL_SPRING_20" + year) | query.startswith("UUFA_DQ_FALL_SPRING_" + year):
            do_query(query, disb_date + " DL Fall Spring Awards 20" + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_DL_SPRING_20" + year) | query.startswith("UUFA_DQ_SPRING_" + year):
            do_query(query, disb_date + " DL Spring Awards 20" + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_DL_UG_PLUS_REFUND_IA_" + year) | query.startswith("UUFA_DQ_UG_PLUS_REFUND_IA_" + year):
            do_query(query, disb_date + " DL UG PLUS Refund Borrower " + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_MISC_DISB_TOTALS_20" + year) | query.startswith("UUFA_MISC_DISB_TOTALS_20" + year):
            do_query(query, disb_date + " Misc Disbursement Totals " + year + ".xlsx", directory,
                     sys_attachment_list)

        if query.startswith("FA_MISC_RESOURCES_DISB_20" + year) | query.startswith("UUFA_DQ_MISC_RESOURCE_DISB_" + year):
            do_query(query, disb_date + " Misc Resources Disbursement " + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_NONCASH_DISB_TOTALS_20" + year) | query.startswith("UUFA_NONCASH_DISB_TOTALS_20" + year):
            do_query(query, disb_date + " Non-cash Disbursement Totals " + year + ".xlsx", directory,
                     sys_attachment_list)

        if query.startswith("FA_PELL_AWDS_ACPT_GRTR_DISB_" + year) | query.startswith("UUFA_DQ_PELL_ACPT_GR8_DISB_" + year):
            do_query(query, disb_date + " Pell Accepted Awards Greater Disb " + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_SF_ITEM_TYPE_ERROR") | query.startswith("UUFA_DQ_SF_ITEM_TYPE_ERROR"):
            do_query(query, disb_date + " FA SF Item Type Error " + year + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_TEACH_GRANT_RECIPIENTS_" + str(int(year) - 1)) | query.startswith("UUFA_DQ_TEACH_GRANT_" + str(int(year) - 1)):
            do_query(query, disb_date + " Teach Grant Recipients 20" + str(int(year) - 1) + ".xlsx", directory,
                     disb_attachment_list)

        if query.startswith("FA_TEACH_GRANT_RECIPIENTS_" + year) | query.startswith("UUFA_DQ_TEACH_GRANT_" + year):
...
def do_2nd_ldr():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_PRT_AWD_PELL_ELG_NO_PELL_") | query_name.startswith("UUFA_PRT_AWD_PLL_ELG_NO_PLL_"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    if test:
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("FA_HRS_DECREASE_ATH") | query.startswith("UUFA_HRS_DECREASE_ATH"):
            do_query(query, date + " Hours Decrease Athlete.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_HRS_DECREASE_FC") | query.startswith("UUFA_HRS_DECREASE_FC"):
            do_query(query, date + " Hours Decrease FC.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_HRS_DECREASE_SV") | query.startswith("UUFA_HRS_DECREASE_SV"):
        ...
        if query.startswith("FA_PELL_OFFERED_NOT_DISB") | query.startswith("UUFA_PELL_OFFERED_NOT_DISB"):
            do_query(query, date + " Pell Offered Not Disbursed.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PELL_DL_MATH990") | query.startswith("UUFA_PELL_DL_MATH990"):
            do_query(query, date + " Pell-DL Math 990.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_PELL_DL_ELI575_ELI685") | query.startswith("UUFA_PELL_DL_ELI575_ELI685"):
            do_query(query, date + " Pell-DL ELI0075 ELI0085.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_SF_DISB_ATHLETIC_AWD_NOPOST") | query.startswith("UUFA_SF_DISB_ATHLETIC_AWD_NOPOST"):
            do_query(query, date + " Athlete Awd Disb not Posted.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_SF_DISB_WAIVER_AWD_NOPOST") | query.startswith("UUFA_SF_DISB_WAIVER_AWD_NOPOST"):
            do_query(query, date + " Waiver Awd Disb not Posted.xlsx", directory,
                     act_attachment_list)

        if query.startswith("FA_PRT_AWD_PELL_ELG_NO_PELL") | query.startswith("UUFA_PRT_AWD_PLL_ELG_NO_PLL_" + year):
            do_query(query, date + " Pell Eligible No Pell 20" + year + ".xlsx", directory,
                     akr_attachment_list)
    ...
    if akr_attachment_list:
        ...
        del akr_attachment_list[:]
    if ckj_attachment_list:
        mailer("", "Second Session LDR Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if act_attachment_list:
...
def do_day_after_ldr():
    ...
    # will be added.
    for query in os.listdir("."):
        if query.startswith("FA_LDR_MINIMUM_ENROLLMENT_ATH") | query.startswith("UUFA_LDR_MIN_ENROLLMENT_ATH"):
            do_query(query, date + " Minimum Enrollment Athlete.xlsx", directory,
                     ckj_attachment_list)

        if query.startswith("FA_LDR_MINIMUM_ENROLLMENT_FC") | query.startswith("UUFA_LDR_MINIMUM_ENROLLMENT_FC"):
            do_query(query, date + " Minimum Enrollment FC (Federal & Campus Based Aid).xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_LDR_MINIMUM_ENROLLMENT_SV") | query.startswith("UUFA_LDR_MINIMUM_ENROLLMENT_SV"):
            do_query(query, date + " Minimum Enrollment SV (Scholarships & Waivers).xlsx", directory,
                     ac_attachment_list)

        if query.startswith("FA_LDR_PELL_AWARDS") | query.startswith("UUFA_LDR_PELL_AWARDS"):
            do_query(query, date + " Pell Awards.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_ATHLETE_AWARD_DISBURSED") | query.startswith("UUFA_ATHLETE_AWARD_DISBURSED"):
        ...
        if query.startswith("FA_PELL_SUMMER_ENROLLMENT") | query.startswith("UUFA_PELL_SUMMER_ENROLLMENT"):
        ...
        if query.startswith("FA_REGISTERED_CENSUS_DATE") | query.startswith("UUFA_REGISTERED_CENSUS_DATE"):
            do_query(query, date + " LDR FA Load Check.xlsx", directory,
                     akr_attachment_list)

        if query.startswith("FA_SF_DISB_ATHLETIC_AWD_NOPOST") | query.startswith("UUFA_SF_DISB_ATH_AWD_NOPOST"):
            do_query(query, date + " Athlete Awd Disb not Posted.xlsx", directory,
                     ckj_attachment_list)
        ...
        if query.startswith("FA_PRT_AWD_PELL_ELG_NO_PELL_" + year) | query.startswith("UUFA_PRT_AWD_PLL_ELG_NO_PLL_" + year):
            do_query(query, date + " Pell Eligible No Pell 20" + year + ".xlsx", directory,
                     akr_attachment_list)
    ...
    if ckj_attachment_list:
        mailer("", "Day After LDR Queries", ckj_mail, "", ckj_attachment_list)
        del ckj_attachment_list[:]
    if akr_attachment_list:
...
def dl_pre_outbound():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_DLR_ENTRANCE_COUNSELING") | query_name.startswith("UUFA_DLR_ENTRANCE_COUNSEL_"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    ...
    # will be added.
    for query in os.listdir("."):
        if query.startswith("FA_DLR_ENTRANCE_COUNSELING") | query.startswith("UUFA_DLR_ENTRANCE_COUNSEL_" + year):
            do_query(query, date + " DL Entrance Counseling I  " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_EFT_DT_LNDR_ERROR") | query.startswith("UUFA_DLR_LOAN_EFT_DT_LNDR_ERR"):
            do_query(query, date + " Loan EFT Date Lender Error.xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_NO_NSLDS") | query.startswith("UUFA_DLR_LOAN_NO_NSLDS_" + year):
            do_query(query, date + " Loan No NSLDS " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_ORIG_ACAD_LVL") | query.startswith("UUFA_DLR_LOAN_ORIG_ACAD_LVL_" + year):
            do_query(query, date + " Loans Academic Level " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_ORIG_EDIT_ERRORS") | query.startswith("UUFA_DLR_LOAN_ORIG_EDIT_ERR"):
            do_query(query, date + " Loan Originate Edit Errors.xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_ORIG_SPLT_CDES") | query.startswith("UUFA_DLR_LOAN_ORIG_SPLT_CDS_" + year):
            do_query(query, date + " Loan Split Codes " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_ORIG_VLOAN_REASONS") | query.startswith("UUFA_DLR_LOAN_ORIG_VLOAN_RSN"):
            do_query(query, date + " Loan ORIG VLOAN Reasons.xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_LOAN_SPC_NEED_OVAWD") | query.startswith("UUFA_DLR_LOAN_SPC_NEED_OVWD_" + year):
            do_query(query, date + " Loan Overaward Special Need " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_NOT_DISBURSED") | query.startswith("UUFA_DLR_NOT_DISBURSED_" + year):
            do_query(query, date + " DL Disbursement Errors " + year + ".xlsx", directory,
                     dl_attachment_list)

        if query.startswith("FA_DLR_UG_PLUS_REFND_INDICATOR") | query.startswith("UUFA_DLR_UG_PLUS_REFND_IND"):
...
def al_pre_outbound():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("FA_ALR_LOAN_ORIG_LNDR_NT_CK_") | query_name.startswith("UUFA_ALR_LOAN_ORG_LND_NT_CK_"):
            year = str(int(re.search(r'\d+', query_name).group()))
            break
    aid_year = "20" + str(int(year) - 1) + "-20" + year
    skip = "n"
    ...
    # will be added.
    for query in os.listdir("."):
        if query.startswith("FA_ALR_110_CHNG_PENDING_TRANS") | query.startswith("UUFA_ALR_110_CHNG_PNDNG_TRANS"):
            do_query(query, date + " Loan Pending Change Transactions.xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_CL_APP_RESPONSE_ERRS") | query.startswith("UUFA_ALR_CL_APP_RESPONSE_ERRS"):
            do_query(query, date + " CL Response Load Errors.xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_EFT_DT_LNDR_ERROR") | query.startswith("UUFA_ALR_LOAN_EFT_DT_LNDR_ERR"):
            do_query(query, date + " Loan EFT Date Lender Errors.xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_ACAD_LVL_" + year) | query.startswith("UUFA_ALR_LOAN_ORIG_ACAD_LVL_" + year):
            do_query(query, date + " Loans Academic Level 20" + year + ".xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_EDIT_ERRORS") | query.startswith("UUFA_ALR_LOAN_ORIG_EDIT_ERRORS"):
            do_query(query, date + " Loan Originate Edit Errors.xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_FA_LOAD_" + year) | query.startswith("UUFA_ALR_LOAN_ORIG_FA_LOAD_" + year):
            do_query(query, date + " Loan ORIG FA Load 20" + year + ".xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_LNDR_NT_CK_" + year) | query.startswith("UUFA_ALR_LOAN_ORG_LND_NT_CK_" + year):
            do_query(query, date + " Loan ORIG Lender Note 20" + year + ".xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_SPLT_CDES_" + year) | query.startswith("UUFA_ALR_LOAN_ORIG_SPLT_CDS_" + year):
            do_query(query, date + " Loan ORIG Split Codes 20" + year + ".xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_ORIG_VLOAN_REASONS") | query.startswith("UUFA_ALR_LOAN_ORIG_VLOAN_RSN"):
            do_query(query, date + " Loan ORIG VLOAN Reasons.xlsx", directory,
                     alt_attachment_list)

        if query.startswith("FA_ALR_LOAN_SPC_NEED_OVAWD_" + year) | query.startswith("UUFA_ALR_LOAN_SPC_NEED_OVWD_" + year):
            do_query(query, date + " Loan Overaward Special Need " + year + ".xlsx", directory,
                     alt_attachment_list)
...
def do_weekly_scholarships():
    ...
    if test:
        directory = os.path.realpath(os.path.join('C:\Testing Bob/', aid_year + ' Scholar\Queries'))
        directory_save = os.path.realpath(os.path.join('C:\Testing Bob/Queries/Save', aid_year ))
    else:
        directory = os.path.realpath(os.path.join('O:\Systems', aid_year + ' Scholar\Queries'))
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("UUFA_MISC_TOTAL_" + year):
            do_query(query, date + " IT Dept Misc Awards Total (10001) " + year + ".xlsx", directory_save,
                     null_attachment_list)

        if query.startswith("UUFA_MISC_NOPOST_20" + year) | query.startswith("UUFA_MISC_NOPOST_" + year):
            do_query(query, date + " 7880013 Dept Misc Awards No Post " + year + ".xlsx", directory_save,
                     ssj_attachment_list)

        if query.startswith("UUFA_BOOKS_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Books Awards Total (10002) " + year + ".xlsx", directory_save,
                     null_attachment_list)

        if query.startswith("UUFA_BOOKS_NOPOST_20" + year) | query.startswith("UUFA_BOOKS_NOPOST_" + year):
            do_query(query, date + " 7880015 Dept Books No Post " + year + ".xlsx", directory_save,
                     ssj_attachment_list)

        if query.startswith("UUFA_ROOMBOARD_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Room & Board Awards Total (10003) " + year + ".xlsx", directory_save,
                     null_attachment_list)

        if query.startswith("UUFA_ROOMBOARD_NOPOST_20" + year) | query.startswith("UUFA_ROOMBOARD_NOPOST_" + year):
            do_query(query, date + " 7880029 Dept Room & Board No Post " + year + ".xlsx", directory_save,
                     ssj_attachment_list)

        if query.startswith("UUFA_TRAVEL_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Travel Awards Total (10004) " + year + ".xlsx", directory_save,
                     null_attachment_list)

        if query.startswith("UUFA_TRAVEL_NOPOST_20" + year) | query.startswith("UUFA_TRAVEL_NOPOST_" + year):
            do_query(query, date + " 7880033 Dept Travel No Post " + year + ".xlsx", directory_save,
                     ssj_attachment_list)

        if query.startswith("UUFA_TRAINEESHIPS_TOTAL_" + year) | query.startswith("UUFA_TRAINEESHIP_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Traineeship Awards Total (10005) " + year + ".xlsx", directory_save,
                     null_attachment_list)

        if query.startswith("UUFA_TRAINEESHIP_NOPOST_20" + year) | query.startswith("UUFA_TRAINEESHIP_NOPOST_" + year):
            do_query(query, date + " 7880034 Dept Traineeship No Post " + year + ".xlsx", directory_save,
                     ssj_attachment_list)
