...
akk_mail = "Amy Capps (acapps@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu);JLykins@sa.utah.edu;Krista Burton (kburton@sa.utah.edu)"
...
akrk_mail = "Amy Capps (acapps@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu);Ryan Christensen (rchristensen@sa.utah.edu);JLykins@sa.utah.edu; Krista Burton (kburton@sa.utah.edu)"
...
alt_mail = "JLykins@sa.utah.edu;Krista Burton <kburton@sa.utah.edu>; Amy Capps <acapps@sa.utah.edu>; Jennifer Berry <jberry@sa.utah.edu>;Mathew Edward Place <mplace@sa.utah.edu>; Scott Wilgar <swilgar@sa.utah.edu>;Veronica Christensen <vchristensen@sa.utah.edu>;LGaray@sa.utah.edu"
atcj_mail = "Amber Cook (acook@sa.utah.edu); Carol Bergstrom <cbergstrom@sa.utah.edu>; Jonathan Leon <JLeon@sa.utah.edu>"
ca_mail = "Amy Capps (acapps@sa.utah.edu)"
cak_mail = "Carol Bergstrom <cbergstrom@sa.utah.edu>; Amy Capps (acapps@sa.utah.edu);Karen Henriquez (Karen.Henriquez@utah.edu)"
disb_mail = "Karen Henriquez (Karen.Henriquez@utah.edu); Steffany Forrest (steffany.forrest@income.utah.edu);cspringer@sa.utah.edu; KAYLA JOY MC CLOYN <kmccloyn@sa.utah.edu>;Lisa Zaelit (lisa.zaelit@admin.utah.edu);Veronica Christensen (vchristensen@sa.utah.edu); Jennifer Berry (jberry@sa.utah.edu);Carol Bergstrom <cbergstrom@sa.utah.edu>; Amy Capps (acapps@sa.utah.edu);Krista Burton (kburton@sa.utah.edu)"
dl_mail = "JLykins@sa.utah.edu;Krista Burton <kburton@sa.utah.edu>; Amy Capps <acapps@sa.utah.edu>;Karen Henriquez <Karen.Henriquez@utah.edu>;Jennifer Berry <jberry@sa.utah.edu>; Mathew Edward Place <mplace@sa.utah.edu>;Scott Wilgar <swilgar@sa.utah.edu>; Veronica Christensen <vchristensen@sa.utah.edu>;LGaray@sa.utah.edu"
jen_mail = "Jennifer Berry <jberry@sa.utah.edu>"
jkar_mail = "John Curl (jcurl@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu); Amy Capps (acapps@sa.utah.edu); Ryan Christensen (rchristensen@sa.utah.edu)"
ka_mail = "JLykins@sa.utah.edu;Krista Burton (kburton@sa.utah.edu); Amy Capps (acapps@sa.utah.edu)"
kaca_mail = "Karen Henriquez (Karen.Henriquez@utah.edu); Amber Cook (acook@sa.utah.edu);Amy Capps (acapps@sa.utah.edu)"
kak_mail = "JLykins@sa.utah.edu;Krista Burton (kburton@sa.utah.edu); Amy Capps (acapps@sa.utah.edu);Karen Henriquez (Karen.Henriquez@utah.edu)"
kc_mail = "Karen.Henriquez@utah.edu"
ckjk_mail = "cspringer@sa.utah.edu; John Curl (jcurl@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu); KAYLA JOY MC CLOYN <kmccloyn@sa.utah.edu>"
ckj_mail = "cspringer@sa.utah.edu;KAYLA JOY MC CLOYN (kmccloyn@sa.utah.edu); John Curl (jcurl@sa.utah.edu)"
