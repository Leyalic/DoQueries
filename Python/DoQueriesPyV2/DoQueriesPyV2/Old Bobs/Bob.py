...
akke_mail = "Amy Capps (acapps@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu);Krista Burton (kburton@sa.utah.edu); Elizabeth Crandell (ecrandell@sa.utah.edu)"
akr_mail = "acapps@sa.utah.edu; karen.henriquez@utah.edu; rchristensen@sa.utah.edu"
akre_mail = "acapps@sa.utah.edu; karen.henriquez@utah.edu; rchristensen@sa.utah.edu; cspringer@sa.utah.edu"
akrke_mail = "Amy Capps (acapps@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu);Ryan Christensen (rchristensen@sa.utah.edu); Krista Burton (kburton@sa.utah.edu);Elizabeth Crandell (ecrandell@sa.utah.edu)"
...
alt_mail = "Krista Burton <kburton@sa.utah.edu>; Amy Capps <acapps@sa.utah.edu>;Elizabeth Crandell <ecrandell@sa.utah.edu>; Jennifer Berry <jberry@sa.utah.edu>;Mathew Edward Place <mplace@sa.utah.edu>; Scott Wilgar <swilgar@sa.utah.edu>;Veronica Christensen <vchristensen@sa.utah.edu>;LGaray@sa.utah.edu"
ar_mail = "acapps@sa.utah.edu; rking@sa.utah.edu"
atcj_mail = "Amber Cook (acook@sa.utah.edu); Tanner Esplin (tesplin@sa.utah.edu);Carol Bergstrom <cbergstrom@sa.utah.edu>; Jonathan Leon <JLeon@sa.utah.edu>"
...
disb_mail = "Karen Henriquez (Karen.Henriquez@utah.edu); Steffany Forrest (steffany.forrest@income.utah.edu);Leila Ames (lames@sa.utah.edu); KAYLA JOY MC CLOYN <kmccloyn@sa.utah.edu>;Lisa Zaelit (lisa.zaelit@admin.utah.edu); Elizabeth Crandell (ecrandell@sa.utah.edu);Veronica Christensen (vchristensen@sa.utah.edu); Jennifer Berry (jberry@sa.utah.edu);Carol Bergstrom <cbergstrom@sa.utah.edu>; Amy Capps (acapps@sa.utah.edu);Krista Burton (kburton@sa.utah.edu)"
dl_mail = "Krista Burton <kburton@sa.utah.edu>; Amy Capps <acapps@sa.utah.edu>;Karen Henriquez <Karen.Henriquez@utah.edu>; Elizabeth Crandell <ecrandell@sa.utah.edu>;Jennifer Berry <jberry@sa.utah.edu>; Mathew Edward Place <mplace@sa.utah.edu>;Scott Wilgar <swilgar@sa.utah.edu>; Veronica Christensen <vchristensen@sa.utah.edu>;LGaray@sa.utah.edu"
...
kake_mail = "Krista Burton (kburton@sa.utah.edu); Amy Capps (acapps@sa.utah.edu);Karen Henriquez (Karen.Henriquez@utah.edu); Elizabeth Crandell (ecrandell@sa.utah.edu)"
...
ljkk_mail = "Leila Ames (lames@sa.utah.edu); John Curl (jcurl@sa.utah.edu); Karen Henriquez (Karen.Henriquez@utah.edu); KAYLA JOY MC CLOYN <kmccloyn@sa.utah.edu>"
...
ss_mail = "Amber Cook <acook@sa.utah.edu>; Carol Bergstrom <cbergstrom@sa.utah.edu>;Cary Lopez <cary.lopez@utah.edu>;Jonathan Leon <JLeon@sa.utah.edu>; MARY SNOW <MSnow@sa.utah.edu>; Sheryl Hansen <shansen@sa.utah.edu>;Tanner Esplin <tesplin@sa.utah.edu>; Jennifer Berry <jberry@sa.utah.edu>;Leonel Garay <LGaray@sa.utah.edu>; Mathew Place <mplace@sa.utah.edu>; Scott Wilgar <swilgar@sa.utah.edu>;Veronica Christensen <vchristensen@sa.utah.edu>"
ssj_mail = "Amber Cook <acook@sa.utah.edu>; Carol Bergstrom <cbergstrom@sa.utah.edu>;Cary Lopez <cary.lopez@utah.edu>;Jonathan Leon <JLeon@sa.utah.edu>; MARY SNOW <MSnow@sa.utah.edu>; Sheryl Hansen <shansen@sa.utah.edu>;Tanner Esplin <tesplin@sa.utah.edu>; Jennifer Berry <jberry@sa.utah.edu>;Leonel Garay <LGaray@sa.utah.edu>; Mathew Place <mplace@sa.utah.edu>; Scott Wilgar <swilgar@sa.utah.edu>;Veronica Christensen <vchristensen@sa.utah.edu>; John Curl (jcurl@sa.utah.edu)"
...
akc_attachment_list = []
akke_attachment_list = []
akr_attachment_list = []
akre_attachment_list = []
akrke_attachment_list = []
...
def do_dailies():
    ...
    for query_name in os.listdir("."):
        if query_name.startswith("FA_IL_CMT_CODE_OVR_AGR_") \
            ...
            if date[6:] in query_name:
                aid_year = "20" + str(int(query_name[-14:-12]) - 1) + "-20" + query_name[-14:-12]
                break
    ...
    if akre_attachment_list:
        mailer("", aid_year + " Daily Queries", akre_mail, "", akre_attachment_list)
        del akre_attachment_list[:]
    if ar_attachment_list:
        mailer("", aid_year + " Daily Queries", ar_mail, "", ar_attachment_list)
        del ar_attachment_list[:]
    if acakr_attachment_list:
        mailer("", aid_year + " Daily Queries", acakr_mail, "", acakr_attachment_list)
        del acakr_attachment_list[:]
    if lj_attachment_list:
        mailer("", aid_year + " Daily Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
...
def do_monday_weeklies():
    ...
    if test:
        directory = os.path.realpath(
            os.path.join('C:\QueryRunnerProj\Testing\Test/Monday Weekly', aid_year, month_folder))
        directory2013 = os.path.realpath(
            os.path.join('C:\QueryRunnerProj\Testing\Test\Monday Weekly', "2012-2013", month_folder))
        directory2014 = os.path.realpath(
            os.path.join('C:\QueryRunnerProj\Testing\Test\Monday Weekly', "2013-2014", month_folder))
        packaging_directory = os.path.realpath(
            os.path.join('C:\QueryRunnerProj\Testing\Test/Packaging', aid_year, month_folder))
        disb_failure_directory = os.path.realpath(
            os.path.join('C:\QueryRunnerProj\Testing\Test/Disb Failure ' + aid_year))
    else:
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("FA_WR_FALL_TOTAL_WTHDRN_DRP_" + year) \
            ...
            do_query(query, date + " Fall Disb Total Withdrawn Drop " + year + " (old).xls", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_FALL_TOTAL_WDRN_DRP_" + year):
        ...
        if query.startswith("FA_WR_SPR_TOTAL_WTHDRN_DRP_" + year):
            do_query(query, date + " Spr Disb Total Withdrawn Drop " + year + " (old).xls", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SPR_TOTAL_WDRN_DRP_" + year) \
                | query.startswith("UUFA_WR_SPR_TOTAL_WDRN_DRP_" + year):
            do_query(query, date + " Spr Disb Total Withdrawn Drop " + year + ".xls", directory,
                     akr_attachment_list)
        ...
        if query.startswith("FA_WR_SUM_TOTAL_WTHDRN_DRP_" + year):
            do_query(query, date + " Sum Disb Total Withdrawn Drop " + year + " (old).xls", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUM_TOTAL_WDRN_DRP_" + year) \
                | query.startswith("UUFA_WR_SUM_TOTAL_WDRN_DRP_" + year):
            do_query(query, date + " Sum Disb Total Withdrawn Drop " + year + ".xls", directory,
                     akr_attachment_list)
        ...
        if query.startswith("FA_WR_SUSP_DOB_PRB_APPLCNT_" + year) \
            ...
            do_query(query, date + " Suspense Applicant DOB Problem 20" + year + ".xls", directory,
                     akr_attachment_list)

        if query.startswith("FA_WR_SUSP_NAME_PRB_APPLCNT_" + year) \
                | query.startswith("UUFA_WR_SSP_NAME_PRB_APLCNT_" + year):
            do_query(query, date + " Suspense Applicant Name Problem 20" + year + ".xls", directory,
                     akr_attachment_list)

        if query.startswith("UUFA_WR_SSP_SSN_PRB_APLCNT_" + year) \
                | query.startswith("UUFA_WR_SSP_SSN_PRB_APLCNT_20" + year):
            do_query(query, date + " Suspense Applicant SSN Problem 20" + year + ".xls", directory,
                     akr_attachment_list)
    ...
    if lj_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
    if akr_attachment_list:
    ...
    if ak_attachment_list:
        ...
        del ak_attachment_list[:]
    if akke_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", akke_mail, "", akke_attachment_list)
        del akke_attachment_list[:]
    if ar_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", ar_mail, "", ar_attachment_list)
        del ar_attachment_list[:]
    ...
    if akc_attachment_list:
        ...
        del akc_attachment_list[:]
    if kake_attachment_list:
        mailer("", aid_year + " Monday Weekly Queries", kake_mail, "", kake_attachment_list)
        del kake_attachment_list[:]
...
def do_budget_queries():
    ...
    if ak_attachment_list:
        ...
        del ak_attachment_list[:]
    if ljk_attachment_list:
        mailer("", aid_year + " Budget Queries", ljkk_mail, "", ljk_attachment_list)
        del ljk_attachment_list[:]
    if akc_attachment_list:
...
def do_packaging_queries():
    ...
    if ak_attachment_list:
        mailer("", aid_year + " Packaging Queries", ak_mail, "", ak_attachment_list)
        del ak_attachment_list[:]
    if lj_attachment_list:
        mailer("", aid_year + " Packaging Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
    if akr_attachment_list:
        mailer("", aid_year + " Packaging Queries", akr_mail, "", akr_attachment_list)
        del akr_attachment_list[:]
    if kc_attachment_list:
        mailer("", aid_year + " Packaging Queries", kc_mail, "", kc_attachment_list)
        del kc_attachment_list[:]
    if ms_attachment_list:
        mailer("", aid_year + " Packaging Queries", vs_mail, "", ms_attachment_list)
        del ms_attachment_list[:]
    if akke_attachment_list:
        mailer("", aid_year + " Packaging Queries", akke_mail, "", akke_attachment_list)
        del akke_attachment_list[:]
    if act_attachment_list:
        mailer("", aid_year + " Packaging Queries", act_mail, "", act_attachment_list)
        del act_attachment_list[:]
    if akrke_attachment_list:
        mailer("", aid_year + " Packaging Queries", akrke_mail, "", akrke_attachment_list)
        del akrke_attachment_list[:]
    if akar_attachment_list:
        mailer("", aid_year + " Packaging Queries", akar_mail, "", akar_attachment_list)
        del akar_attachment_list[:]
    if kak_attachment_list:
        mailer("", aid_year + " Packaging Queries", kak_mail, "", kak_attachment_list)
        del kak_attachment_list[:]
...
def do_monthlies():
    ...
    if akr_attachment_list:
        ...
        del akr_attachment_list[:]
    if lj_attachment_list:
        mailer("", aid_year + " Monthly Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
    if act_attachment_list:
    ...
    if ar_attachment_list:
        mailer("", aid_year + " Monthly Queries", ar_mail, "", ar_attachment_list)
        del ar_attachment_list[:]
    if kak_attachment_list:
    ...
    if acvj_attachment_list:
        mailer("", aid_year + " Monthly Queries", acv_mail, "", acvj_attachment_list)
...
def do_end_of_term_queries():
    ...
    for query_name in os.listdir("."):
        if query_name.startswith("FA_ACADEMIC_PLAN_RVW_FRAP") \
                | query_name.startswith("UUFA_ACADEMIC_PLAN_RVW_FRAP_"):
            aid_year = "20" + str(int(query_name[-16:-14]) - 1) + "-20" + query_name[-16:-14]
            prompt = "Which term is this for? S, F, or U?: "
            while True:
                term = str.upper(raw_input(prompt))
    ...
    for query in os.listdir("."):
        if query.startswith("FA_ACADEMIC_PLAN_RVW_FRAP") \
                | query.startswith("UUFA_ACADEMIC_PLAN_RVW_FRAP_" + year):
    ...
    if kc_attachment_list:
        ...
        del kc_attachment_list[:]
    if lj_attachment_list:
        mailer("", "End of Term Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
...
def do_2nd_ldr():
    ...
    if akr_attachment_list:
        ...
        del akr_attachment_list[:]
    if lj_attachment_list:
        mailer("", "Second Session LDR Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
    if act_attachment_list:
...
def do_day_after_ldr():
    ...
    for query_name in os.listdir("."):
        if query_name.startswith("FA_PRT_AWD_PELL_ELG_NO_PELL_") \
                | query_name.startswith("UUFA_PRT_AWD_PLL_ELG_NO_PLL_"):
            aid_year = "20" + str(int(query_name[-11:-9]) - 1) + "-20" + query_name[-11:-9]
            break
    ...
    if lj_attachment_list:
        mailer("", "Day After LDR Queries", lkj_mail, "", lj_attachment_list)
        del lj_attachment_list[:]
    if akr_attachment_list:
...
def dl_pre_outbound():
    ...
    orig_file_docx = date + " DL ORIG 20" + year + ".doc"
    if test:
        directory = os.path.realpath(os.path.join('C:\QueryRunnerProj\Testing\Test/Direct Loans',
                                                  aid_year, 'DL Pre-Outbound'))
    ...
    if not test:
        while True:
            ...
            if os.path.isfile(orig_docx):
                ...
                raw_input("\nCould not locate DL ORIG 20" + year +
...
def do_mid_repack_queries():
    ...
    if ak_attachment_list:
        mailer("", "Pell Repackaging Mid-Packaging Queries", ak_mail, sys_mail, ak_attachment_list)
        del ak_attachment_list[:]
...
def do_weekly_scholarships():
    global aid_year
    for query_name in os.listdir("."):
        if query_name.startswith("UUFA_BOOKS_"):
            if date[6:] in query_name:
                aid_year = "20" + str(int(query_name[-14:-12]) - 1) + "-20" + query_name[-14:-12]
                break
            if str(int(date[6:]) + 1) in query_name:
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("UUFA_MISC_TOTAL_" + year):
            do_query(query, date + " IT Dept Misc Awards Total (10001) " + year + ".xls", directory,
                     null_attachment_list)
        if query.startswith("UUFA_MISC_NOPOST_20" + year) \
                | query.startswith("UUFA_MISC_NOPOST_" + year):
            do_query(query, date + " 7880013 Dept Misc Awards No Post " + year + ".xls", directory,
                     ssj_attachment_list)
        if query.startswith("UUFA_BOOKS_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Books Awards Total (10002) " + year + ".xls", directory,
                     null_attachment_list)
        if query.startswith("UUFA_BOOKS_NOPOST_20" + year) \
                | query.startswith("UUFA_BOOKS_NOPOST_" + year):
            do_query(query, date + " 7880015 Dept Books No Post " + year + ".xls", directory,
                     ssj_attachment_list)
        if query.startswith("UUFA_ROOMBOARD_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Room & Board Awards Total (10003) " + year + ".xls", directory,
                     null_attachment_list)
        if query.startswith("UUFA_ROOMBOARD_NOPOST_20" + year) \
                | query.startswith("UUFA_ROOMBOARD_NOPOST_" + year):
            do_query(query, date + " 7880029 Dept Room & Board No Post " + year + ".xls", directory,
                     ssj_attachment_list)
        if query.startswith("UUFA_TRAVEL_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Travel Awards Total (10004) " + year + ".xls", directory,
                     null_attachment_list)
        if query.startswith("UUFA_TRAVEL_NOPOST_20" + year) \
                | query.startswith("UUFA_TRAVEL_NOPOST_" + year):
            do_query(query, date + " 7880033 Dept Travel No Post " + year + ".xls", directory,
                     ssj_attachment_list)
        if query.startswith("UUFA_TRAINEESHIPS_TOTAL_" + year) \
                | query.startswith("UUFA_TRAINEESHIP_TOTAL_" + year):
            do_query(query, date + " 788 IT Dept Traineeship Awards Total (10005) " + year + ".xls", directory,
                     null_attachment_list)
        if query.startswith("UUFA_TRAINEESHIP_NOPOST_20" + year) \
                | query.startswith("UUFA_TRAINEESHIP_NOPOST_" + year):
            do_query(query, date + " 7880034 Dept Traineeship No Post " + year + ".xls", directory,
                     ssj_attachment_list)
...
for filename in os.listdir("."):
    ...
    if filename.startswith("FA_DLR_ENTRANCE_COUNSELING") \
            | filename.startswith("UUFA_DLR_ENTRANCE_COUNSEL_"):
        dl_pre_outbound()
    # Alternative Loan Pre-Outbound Queries
    if filename.startswith("FA_ALR_LOAN_ORIG_LNDR_") \
            | filename.startswith("UUFA_ALR_LOAN_ORG_LND_NT_CK_"):
        al_pre_outbound()
    ...
    if filename.startswith("UUFA_BOOKS_"):
