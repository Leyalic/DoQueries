...
def do_dailies():
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("FA_IL_FBKP" + year + "_CHECKLIST_" + year) | query.startswith("UUFA_IL_FBKP16_CHECKLIST_" + year):
...
def do_monday_weeklies():
    ...
    for query in os.listdir("."):
        ...
        if query.startswith("UUFA_WR_EFT_CONSENT_VERIF" + year):
