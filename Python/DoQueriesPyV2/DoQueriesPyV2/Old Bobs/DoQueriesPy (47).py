...
acakr_mail =    send_to(amber, carol, ryan, karen)
...
akar_mail =     send_to(ryan, karen, anne)
akc_mail =      send_to(ryan, karen, carol)
akcal_mail =    send_to(ryan, karen, carol, amber, leila)
akl_mail =      send_to(ryan, karen, linh)
akr_mail =      send_to(ryan, karen)
prof_akr_mail = send_to(ryan, karen, prof)
akrj_mail =     send_to(ryan, karen, john)
akrv_mail =     send_to(ryan, karen, veronica)
...
disb_mail =     send_to(loans, ryan, karen, steffany, chelsea, amber, carol, kayla, lisa, systems)
